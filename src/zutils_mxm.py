...
class Proxy():
    ...
    def start(self):
        ...
        broker_path = self.brokerpath + '/' + self.broker_id
        ...
        if self.zk.exists(self.path):
            ...
            def proxy_watcher(data, stat):
                ...
                if data is None:
                    ...
                    election = self.zk.Election(self.brokerpath + '/', self.broker_id)
